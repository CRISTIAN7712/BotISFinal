...
const { bgYellow, cyan, yellow, bgCyan } = require$$2;
...
const start = (args) => {
    ...
    const banner = () => {
        console.log(``);
        console.log(bgCyan(`🤖 ESCANEAR QR 🤖`));
        console.log(cyan(`Para iniciar BotIS debes escanear el QR code`));
        console.log(cyan(`- En esta ruta 👉 `), yellow(`${publicSite}:${port}`));
        console.log(cyan(`- Entre los archivos se ha creado 👉 `), yellow('qr.png'));
        console.log(``);
    };
